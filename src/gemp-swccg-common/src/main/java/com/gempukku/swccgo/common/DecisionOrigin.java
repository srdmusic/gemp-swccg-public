...
public enum DecisionOrigin {
    ...
    DEPLOY_DESTINATION("CARD_SELECTION"),
    DEPLOY_BUDDY("CARD_SELECTION"),
    DEPLOY_BUDDY_ARBITRARY("ARBITRARY_CARDS"),
    DEPLOY_V170_UNDERCOVER("MULTIPLE_CHOICE"),
    DEPLOY_CAPACITY("MULTIPLE_CHOICE"),
    DEPLOY_CONFIRMATION("MULTIPLE_CHOICE"),
    BATTLE_ACTION("CARD_ACTION_CHOICE"),
    BATTLE_FORFEIT("CARD_SELECTION"),
    BATTLE_POWER("MULTIPLE_CHOICE"),
    BATTLE_DESTINY_SELECTION("ARBITRARY_CARDS"),

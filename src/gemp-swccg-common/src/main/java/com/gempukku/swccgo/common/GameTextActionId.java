...
public enum GameTextActionId {
    ...
    A_GOOD_FRIEND__DEPLOY_JEDI_VILLAGE_OR_BE_WITH_ME(true),
    ...
    MIND_WHAT_YOUR_HAVE_LEARNED_V__DOWNLOAD_LOCATION(true),
    ...
    PATIENCE__DOWNLOAD_LOCATION(true),
    ...
    SAVE_YOU_IT_CAN__RETRIEVE_REBEL_OR_WEAPON_INTO_HAND(true),
    SAVE_YOU_IT_CAN__UPLOAD_LUKE_FROM_LOST_PILE(true),

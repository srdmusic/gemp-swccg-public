...
public enum GameTextActionId {
    ...
    IM_SORRY_V__DOWNLOAD_CARD(true),
    ...
    OMMNI_BOX_ITS_WORSE_V__UPLOAD_CHARACTER(true),
    ...
    PELI_MOTTO__RETRIEVE_GROGU(true),
    ...
    THE_HIDDEN_PATH__DOWNLOAD_CARD(true),
    ...
    JABIIM_HANGAR_BAY__DOWNLOAD_GRAND_INQUISITOR(true, true),
    ...
    KELLERAN_BEQ__DEPLOY_LIGHTSABERS(true, true),
    ...
    MAPUZO_SAFEHOUSE__DOWNLOAD_TALA(true, true),

...
public enum GameTextActionId {
    ...
    PUT_ALL_SECTIONS_ON_ALERT__DOWNLOAD_IMPERIAL_DECREE(true),
    ...
    ELECTRO_RANGEFINDER__UPLOAD_CARD_FROM_PILE(true, true),
    ...
    JABBAS_LAST_CHANCE__TAKE_FIRST_WEAPONS_SEGMENT_ACTION(false, true),
    ...
    PUT_ALL_SECTIONS_ON_ALERT__DOWNLOAD_LIFT_TUBE(true, true),

    ...
    public List<EvaluatedAction> evaluate(DecisionContext context) {
        ...
        for (int i = 0; i < actionIds.size(); i++) {
            ...
            if (textLower.contains("from reserve deck")
                ...
                try {
                    com.gempukku.swccgo.ai.models.rando.strategy.DeckOracle v177Oracle =
                    ...
                    if (v177Oracle != null && v177Oracle.isAnalyzed()
                        ...
                        if (v177Targets.isEmpty() && v177Src != null && v177Src.getBlueprint() != null) {
                            ...
                            if (!v183Named.isEmpty()) {
                                ...
                                for (com.gempukku.swccgo.ai.models.rando.strategy.DeckOracle.DeckCard v183Dc : v183Named) {
            ...
            if (cardId != null && gameState != null
                ...
                try {
                    ...
                    if (v155Src != null && v155Src.getTitle() != null
                        ...
                        String v155Why = null;
                        com.gempukku.swccgo.ai.models.rando.strategy.DeckOracle v155Oracle = context.getDeckOracle();
            ...
            if (textLower.contains("target the main generator")) {
                com.gempukku.swccgo.ai.models.rando.strategy.ObjectiveAnalyzer v160OA = context.getObjectiveAnalyzer();
                ...
                try {
                    ...
                    if (v120m.find()) {
                        ...
                        if (v120WeaponBp != null) {
                            String v120Criteria = com.gempukku.swccgo.ai.models.rando.evaluators
                            ...
                            if (v120Criteria != null) {
                                ...
                                for (PhysicalCard tc : gameState.getAllPermanentCards()) {
                                    ...
                                    try {
                                        v120Match = com.gempukku.swccgo.ai.models.rando.evaluators
                        ...
                        try {
                            ...
                            if (v131Src != null && v131Src.getBlueprint() != null) {
                                ...
                                if (v131Gt != null) {
                                    ...
                                    com.gempukku.swccgo.ai.models.rando.strategy.DeckOracle v131Oracle =
                                        context.getDeckOracle();
                                    for (String v131T : v131Tgts) {
                                        ...
                                        if (isLoc) {
                                            ...
                                            com.gempukku.swccgo.filters.Filter v131F = com.gempukku.swccgo.ai.models.rando.strategy.DeckOracle
                                    ...
                                    if (fsGtl.matches("(?s).*(?:\\[download\\]|deploy|take)[^.;]*\\bhere\\b.*")) {
                                        ...
                                        if (fsPulled != null) {
                                            ...
                                            if (!fsFlipPlan) {
                                                ...
                                                // V201: this forced Reserve pull is not part of the exact
                                                // hand-built DeploymentPlan. Mere character presence in hand
                                                // is not a same-destination sequence, so no companion is claimed.
                                                com.gempukku.swccgo.ai.models.common.strategy.FormationSafety.DeployVerdict fsVerdict =
                                                    ...
                                                    .assessCharacterDeploy(context.getGame(), gameState, context.getPlayerId(),
                                                        ...
                                                        false, fsSrc, fsForce, fsCost, null, null);
                                                if (fsVerdict.constraint() == com.gempukku.swccgo.ai.models.common.strategy.FormationSafety.DeployConstraint.HARD_BLOCK) {
                                                    ...
                                                    logger.warn("FORMATION SAFETY (pull-route): {}", fsVerdict.reason());
                                                    ...
                                                    logger.warn("V201 PULL DEFER: {}", fsVerdict.reason());
                                                } else if (fsVerdict.constraint() == com.gempukku.swccgo.ai.models.common.strategy.FormationSafety.DeployConstraint.UNKNOWN) {
                                                    action.addReasoning("V201 pull formation assessment unknown: " + fsVerdict.reason());
                                                }
                                            } else {

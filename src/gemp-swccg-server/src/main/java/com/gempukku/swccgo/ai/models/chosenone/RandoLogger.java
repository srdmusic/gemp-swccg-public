 ...
 *
 * Logger hierarchy:
 * - com.gempukku.swccgo.ai.models.chosenone (base - defaults to WARN for production)
 *   - com.gempukku.swccgo.ai.models.chosenone.decision (decision processing)
 *   - com.gempukku.swccgo.ai.models.chosenone.evaluator (evaluator scoring)
 *   - com.gempukku.swccgo.ai.models.chosenone.strategy (strategy planning)
 *   - com.gempukku.swccgo.ai.models.chosenone.safety (loop detection, critical safety)
 *
 * To enable verbose Rando logging, add to log4j2.xml:
 * <Logger name="com.gempukku.swccgo.ai.models.chosenone" level="DEBUG" additivity="false">
 *     <AppenderRef ref="Console"/>
 * </Logger>
 *
 * To see only safety/critical issues:
 * <Logger name="com.gempukku.swccgo.ai.models.chosenone" level="WARN" additivity="false">
 *     <AppenderRef ref="Console"/>
 * </Logger>
 */
public final class RandoLogger {
    ...
    public static final String BASE_LOGGER_NAME = "com.gempukku.swccgo.ai.models.chosenone";

        ...
        for (int i = 0; i < actionIds.size(); i++) {
            ...
            if (card != null) {
                ...
                if (blueprint != null) {
                    ...
                    {
                        com.gempukku.swccgo.ai.models.chosenone.strategy.ObjectiveAnalyzer objDeploy =
                            context.getObjectiveAnalyzer();
...
//                            && gameState != null && game != null) {
//                        com.gempukku.swccgo.ai.models.chosenone.strategy.ObjectiveAnalyzer v110Obj =
//                            context.getObjectiveAnalyzer();
                            ...
                            if (instruction != null) {
                                ...
                                if (plan.getStrategy() == DeployStrategy.DEPLOY_LOCATIONS) {
                                    ...
                                    if (planCheckCategory == CardCategory.LOCATION) {
                                        ...
                                        com.gempukku.swccgo.ai.models.chosenone.strategy.ObjectiveAnalyzer dlObjAnalyzer =
                                            context.getObjectiveAnalyzer();
...
//                                 } catch (Exception e) { /* ignore */ }
                    ...
                    if (blueprint.getCardCategory() == CardCategory.CHARACTER && gameState != null) {
                        try {
                            com.gempukku.swccgo.ai.models.chosenone.strategy.ObjectiveAnalyzer huntDeployAnalyzer =
                                context.getObjectiveAnalyzer();
                    ...
                    if (category == CardCategory.WEAPON && gameState != null) {
                        try {
                            ...
                            try {
                                v158Criteria = com.gempukku.swccgo.ai.models.chosenone.evaluators
                            ...
                            for (PhysicalCard tc : gameState.getAllPermanentCards()) {
                                ...
                                if (v158Criteria != null) {
                                    boolean m = false;
                                    try {
                                        m = com.gempukku.swccgo.ai.models.chosenone.evaluators

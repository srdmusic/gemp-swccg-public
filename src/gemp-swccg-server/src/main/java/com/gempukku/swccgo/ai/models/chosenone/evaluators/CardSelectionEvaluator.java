                                ...
                                if (v136DepBp != null
                                    ...
                                    if (v136DeployingCard != null) {
                                        ...
                                        boolean v136ObjRelevant = v136Obj != null && v136Obj.isAnalyzed()
                                            && title != null
                                            && v136Obj.isObjectiveRelevantLocation(title);
                ...
                try {
                    ...
                    if (card != null) {
                        ...
                        if (card.getBlueprint() != null) {
                            com.gempukku.swccgo.ai.models.chosenone.strategy.ObjectiveAnalyzer v109Obj =
                                context.getObjectiveAnalyzer();
                ...
                if (gameState != null) {
                    try {
                        ...
                        if (v153Card != null) {
                            ...
                            if (v153Title != null) {
                                com.gempukku.swccgo.ai.models.chosenone.strategy.ObjectiveAnalyzer v153OA = context.getObjectiveAnalyzer();
        ...
        for (int i = 0; i < cardIds.size(); i++) {
            ...
            if (blueprint != null && category == CardCategory.CHARACTER
                ...
                try {
                    ...
                    com.gempukku.swccgo.ai.models.chosenone.strategy.ObjectiveAnalyzer rsObjAnalyzer =
                        context.getObjectiveAnalyzer();

...
// ═══════════════════════════════════════════════════════════
// ═══ SECTION: ACTIVATE/CONTROL OPTION 2 / SHADOW ROUTE (2026-07-13) ═══
...
// not own (absent/unknown origin, wrong phase, or wrong wire shape). There is NO
// production consumer of these routes in this phase; the resolver runs shadow-only.
// ═══════════════════════════════════════════════════════════

...
public class StrategyControllerTraceTest {
    ...
    public void sideSetThenResetPreservesSideAndReason() {
        ...
        c.setSide(Side.DARK);
        StrategySideSetEvent sideEvent = StrategySideSetEvent.of(StrategyControllerOwner.CHOSENONE,
        ...
        c.reset();
        StrategyResetEvent freshReset = StrategyResetEvent.of(StrategyControllerOwner.CHOSENONE,
            beforeReset, snap(c));
        ...
        c.reset();
        StrategyResetEvent dirtyReset = StrategyResetEvent.of(StrategyControllerOwner.CHOSENONE,
            dirty, snap(c));
    ...
    public void startTurnLeavesForceDeficitStale() {
        ...
        c.startNewTurn(5);
        StrategyStartTurnEvent event = StrategyStartTurnEvent.of(StrategyControllerOwner.CHOSENONE,
            5, before, snap(c));
    ...
    public void startTurnReserveCooldownClearsAndRetains() {
        ...
        c.startNewTurn(4);
        StrategyStartTurnEvent retain = StrategyStartTurnEvent.of(StrategyControllerOwner.CHOSENONE,
            4, before, snap(c));
        ...
        c.startNewTurn(7);
        StrategyStartTurnEvent clear = StrategyStartTurnEvent.of(StrategyControllerOwner.CHOSENONE,
            7, before2, snap(c));
    ...
    public void focusDeployTransitions() {
        ...
        assertEquals(MutationOutcome.NO_OP, StrategyFocusDeployRecordEvent.of(
            StrategyControllerOwner.CHOSENONE, "character", balancedBefore, snap(c)).outcome());
        ...
        assertEquals(MutationOutcome.NO_OP, StrategyFocusDeployRecordEvent.of(
            StrategyControllerOwner.CHOSENONE, "starship", nonMatchBefore, snap(c)).outcome());
        ...
        StrategyFocusDeployRecordEvent firstEvent = StrategyFocusDeployRecordEvent.of(
            StrategyControllerOwner.CHOSENONE, "character", first, snap(c));
        ...
        StrategyFocusDeployRecordEvent secondEvent = StrategyFocusDeployRecordEvent.of(
            StrategyControllerOwner.CHOSENONE, "vehicle", second, snap(c));
    ...
    public void battleResultRepeatsAndLossKeepsFocusCounters() {
        ...
        StrategyBattleResultRecordEvent win1 = StrategyBattleResultRecordEvent.of(
            StrategyControllerOwner.CHOSENONE, true, w0, snap(c));
        ...
        StrategyBattleResultRecordEvent win2 = StrategyBattleResultRecordEvent.of(
            StrategyControllerOwner.CHOSENONE, true, w1, snap(c));
        ...
        StrategyBattleResultRecordEvent loss = StrategyBattleResultRecordEvent.of(
            StrategyControllerOwner.CHOSENONE, false, lBefore, snap(c));
    ...
    public void battleOrderRefreshFoldsTheScan() {
        ...
        assertEquals(MutationOutcome.NO_OP, StrategyBattleOrderRefreshEvent.of(
            StrategyControllerOwner.CHOSENONE, empty0, snap(c)).outcome());
        ...
        StrategyBattleOrderRefreshEvent detected = StrategyBattleOrderRefreshEvent.of(
            StrategyControllerOwner.CHOSENONE, before, snap(c));
        ...
        StrategyBattleOrderRefreshEvent wrongZone = StrategyBattleOrderRefreshEvent.of(
            StrategyControllerOwner.CHOSENONE, on, snap(c));
        ...
        assertEquals(MutationOutcome.NO_OP, StrategyBattleOrderRefreshEvent.of(
            StrategyControllerOwner.CHOSENONE, before2, snap(c)).outcome());
    }

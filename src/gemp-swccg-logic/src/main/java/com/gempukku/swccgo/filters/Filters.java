...
public class Filters {
    ...
    public static final Filter Bo_Katan = Filters.title(Title.Bo_Katan);
    ...
    public static final Filter Death_Squadron_card = Filters.keyword(Keyword.DEATH_SQUADRON);
    ...
    public static final Filter deploys_on_location = Filters.or(Filters.keyword(Keyword.DEPLOYS_ON_LOCATION), Filters.keyword(Keyword.DEPLOYS_ON_SITE));
    ...
    public static final Filter Imperial_veteran = Filters.and(Icon.IMPERIAL, Filters.or(Keyword.LEADER, Filters.and(Filters.trooper, Filters.not(Filters.keyword(Keyword.CADET)))));
    ...
    public static final Filter Laudica = Filters.persona(Persona.LAUDICA);
    ...
    public static final Filter non_Dark_Jedi_character = Filters.and(CardCategory.CHARACTER, Filters.not(Filters.and(Filters.side(Side.DARK), Filters.abilityMoreThanOrEqualTo(6))));
    ...
    public static final Filter Perosei = Filters.persona(Persona.PEROSEI);
    ...
    public static final Filter Rebel_veteran = Filters.and(Icon.REBEL, Filters.or(Keyword.LEADER, Filters.and(Filters.trooper, Filters.not(Filters.keyword(Keyword.RECRUIT)))));
    ...
    public static final Filter Sabe = Filters.persona(Persona.SABE);
    ...
    public static final Filter The_Asset = Filters.keyword(Keyword.THE_ASSET);

 ...
 */
public class AbilityMoreThanRequiredForBattleDestinyModifier extends AbstractModifier {
     ...
     */
    public AbilityMoreThanRequiredForBattleDestinyModifier(PhysicalCard source, Filterable locationFilter, Condition condition, int value, String playerId) {
    ...
    public String getText(GameState gameState, ModifiersQuerying modifiersQuerying, PhysicalCard self) {
        ...
        if (_playerId.equals(gameState.getDarkPlayer()))
            return "Dark side requires total ability of more than " + GuiUtils.formatAsString(value) + " to draw battle destiny";
        else
            return "Light side requires total ability of more than" + GuiUtils.formatAsString(value) + " to draw battle destiny";
    }

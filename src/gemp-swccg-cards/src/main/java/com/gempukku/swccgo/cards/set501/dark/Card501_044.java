 ...
 */
public class Card501_044 extends AbstractNormalEffect {
    public Card501_044() {
        super(Side.DARK, 4, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.An_Inkling_Of_Its_Destructive_Potential, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setTestingText("An Inkling Of Its Destructive Power (ERRATA)");
        hideFromDeckBuilder();
    }

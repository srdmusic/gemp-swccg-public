...
public class Card501_068 extends AbstractAlienImperial {
    public Card501_068() {
        ...
        setGameText("May deploy as a 'react.' Imperials move to same site for free using landspeed. Unless Garindan 'hit,' may place him in Used Pile to cancel a just drawn weapon destiny targeting your other character here (or to make an Undercover spy here lost).");
    ...
    protected List<Modifier> getGameTextAlwaysOnModifiers(SwccgGame game, PhysicalCard self) {
        ...
        modifiers.add(new MovesFreeToLocationUsingLandspeedModifier(self, Filters.Imperial, Filters.sameSite(self)));
        return modifiers;
    }

 ...
 */
public class Card501_214 extends AbstractRebel {
    public Card501_214() {
        super(Side.LIGHT, 1, 4, 4, 3, 6, "Han Solo, Optimistic General", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

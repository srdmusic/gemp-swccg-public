 ...
 * Title: Rebel Assault
 */
public class Card501_166 extends AbstractUsedInterrupt {
    public Card501_166() {
        super(Side.LIGHT, 3, "Rebel Assault", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

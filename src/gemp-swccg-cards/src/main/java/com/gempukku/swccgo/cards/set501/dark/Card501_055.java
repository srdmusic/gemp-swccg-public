 ...
 */
public class Card501_055 extends AbstractNormalEffect {
    public Card501_055() {
        super(Side.DARK, 4, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.Quietly_Observing, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

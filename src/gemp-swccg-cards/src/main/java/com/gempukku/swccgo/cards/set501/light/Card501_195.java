 ...
 */
public class Card501_195 extends AbstractDefensiveShield {
    public Card501_195() {
        super(Side.LIGHT, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "Yavin Sentry & Goldenrod", ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setTestingText("Yavin Sentry & Goldenrod");
    }

 ...
 * Title: Thrown Back (V)
 */
public class Card501_200 extends AbstractDefensiveShield {
    public Card501_200() {
        super(Side.LIGHT, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.Thrown_Back, ExpansionSet.PLAYTESTING, Rarity.V);

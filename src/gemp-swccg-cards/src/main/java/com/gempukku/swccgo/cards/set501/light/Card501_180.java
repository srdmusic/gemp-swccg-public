 ...
 */
public class Card501_180 extends AbstractCombatVehicle {
    public Card501_180() {
        super(Side.LIGHT, 2, 3, 5, null, 5, 4, 5, "Dash In Rogue 12", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        setLore("Enclosed.");

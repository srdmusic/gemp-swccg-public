 ...
 */
public class Card501_220 extends AbstractSite {
    public Card501_220() {
        super(Side.LIGHT, "Kef Bir: Oceanic Wreckage", Title.Kef_Bir, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setTestingText("Kef Bif: Oceanic Wreckage");
        hideFromDeckBuilder();
    }

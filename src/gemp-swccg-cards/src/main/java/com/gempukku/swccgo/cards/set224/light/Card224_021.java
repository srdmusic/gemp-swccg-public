 ...
 */
public class Card224_021 extends AbstractStarfighter {
    public Card224_021() {
        super(Side.LIGHT, 4, 2, 2, null, 3, 6, 4, "StarSpeeder 3000", Uniqueness.UNRESTRICTED, ExpansionSet.SET_24, Rarity.V);

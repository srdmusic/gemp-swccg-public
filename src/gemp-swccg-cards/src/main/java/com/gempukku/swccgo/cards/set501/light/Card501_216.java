...
public class Card501_216 extends AbstractStartingInterrupt {
    public Card501_216() {
        ...
        setGameText("If your starting location was Slave Quarters, deploy Prophecy Of The Force there, Jedi Business, and Your Thoughts Dwell On Your Mother. [Upload] City Outskirts. Light Side goes first. When you draw your starting hand, draw only 6 cards. Place Interrupt in Lost Pile.");
    ...
    protected PlayInterruptAction getGameTextStartingAction(final String playerId, final SwccgGame game, final PhysicalCard self) {
        ...
        if (startingLocation != null && Filters.Slave_Quarters.accepts(game, startingLocation)) {

 ...
 * Title: Jabba's Haven
 */
public class Card501_056 extends AbstractNormalEffect {
    public Card501_056() {
        super(Side.DARK, 4, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "Jabba's Haven", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

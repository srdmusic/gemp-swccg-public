...
public class Card501_066 extends AbstractObjective {
    public Card501_066() {
        ...
        setGameText("Deploy one Cloud City battleground site and I'm Sorry. For remainder of game, Surreptitious Glance may not cancel Dark Deal and your Bespin system may not be converted. While this side up, once per turn, may [upload] Bespin system, Dark Deal, or Cloud City Occupation. Flip this card if Dark Deal (V) on table, you occupy Bespin System and opponent controls less than 3 Cloud City battlegrounds.");

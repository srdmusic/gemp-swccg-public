 ...
 */
public class Card501_162 extends AbstractObjective {
    public Card501_162() {
        super(Side.LIGHT, 0, "Zero Hour", ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setGameText("Deploy Lothal system and a Lothal site." +
                ...
                "Jedi (except Ahsoka and Kanan), and your [Episode I] and [Episode VII] cards with ability are deploy +2. " +
    ...
    protected RequiredGameTextTriggerAction getGameTextAfterDeploymentCompletedAction(String playerId, SwccgGame game, final PhysicalCard self, final int gameTextSourceCardId) {
        ...
        action.appendEffect(
                new AddUntilEndOfGameModifierEffect(action,
                        new DeployCostModifier(self, Filters.or(Filters.and(Filters.Jedi, Filters.except(Filters.or(Filters.Ahsoka, Filters.Kanan))), Filters.and(Filters.or(Icon.EPISODE_I, Icon.EPISODE_VII), Filters.hasAbilityOrHasPermanentPilotWithAbility)), 2),
                        null));
        action.appendEffect(
                new AddUntilEndOfGameModifierEffect(action,

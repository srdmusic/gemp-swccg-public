...
public class Card501_069 extends AbstractDefensiveShield {
    public Card501_069() {
        ...
        setGameText("Plays on table. Stone Pile is canceled. While a Jedi Test on table, Projection Of A Skywalker is canceled. Domain Of Evil may not modify destiny draws more than once per battle (twice if Luke is apprentice).");
        addIcons(Icon.VIRTUAL_DEFENSIVE_SHIELD);
        setTestingText("Failure At The Cave (V) (ERRATA)");
    }

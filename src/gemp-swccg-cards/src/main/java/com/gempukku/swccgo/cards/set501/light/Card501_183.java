 ...
 * Title: Wokling (V)
 */
public class Card501_183 extends AbstractNormalEffect {
    public Card501_183() {
        super(Side.LIGHT, 2, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.Wokling, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

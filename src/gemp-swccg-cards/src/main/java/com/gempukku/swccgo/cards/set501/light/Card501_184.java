 ...
 */
public class Card501_184 extends AbstractNormalEffect {
    public Card501_184() {
        super(Side.LIGHT, 4, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "We'll Take The Long Way", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

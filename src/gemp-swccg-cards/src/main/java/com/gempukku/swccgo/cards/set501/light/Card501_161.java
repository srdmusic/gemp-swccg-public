 ...
 */
public class Card501_161 extends AbstractUsedOrLostInterrupt {
    public Card501_161() {
        super(Side.LIGHT, 4, Title.This_Is_My_Ship, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

...
public class Card201_006 extends AbstractDroid {
    public Card201_006() {
        ...
        setGameText("While aboard a starfighter, adds 2 to power, maneuver, and hyperspeed. " +
                "While present with a Scomp link, adds one [Light Side] icon here and, once per turn during battle at same or related interior site, may use 1 Force to subtract 1 from a just drawn destiny.");

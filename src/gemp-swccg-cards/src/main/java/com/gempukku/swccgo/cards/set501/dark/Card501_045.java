 ...
 * Title: Drop! (V)
 */
public class Card501_045 extends AbstractDefensiveShield {
    public Card501_045() {
        super(Side.DARK, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.Drop, ExpansionSet.PLAYTESTING, Rarity.V);

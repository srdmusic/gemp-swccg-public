 ...
 * Title: Shield Gate
 */
public class Card501_045 extends AbstractDevice {
    public Card501_045() {
        super(Side.DARK, 0, PlayCardZoneOption.ATTACHED, Title.Shield_Gate, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        setLore("");

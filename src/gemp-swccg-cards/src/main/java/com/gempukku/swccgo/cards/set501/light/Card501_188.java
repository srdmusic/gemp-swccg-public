 ...
 */
public class Card501_188 extends AbstractJediMaster {
    public Card501_188() {
        super(Side.LIGHT, 1, 7, 6, 7, 8, "Qui-Gon Jinn, Serene Jedi", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        setLore("");

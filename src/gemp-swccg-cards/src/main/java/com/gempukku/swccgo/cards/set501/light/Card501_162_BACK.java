 ...
 */
public class Card501_162_BACK extends AbstractObjective {
    public Card501_162_BACK() {
        super(Side.LIGHT, 7, "Liberation of Lothal", ExpansionSet.PLAYTESTING, Rarity.V);

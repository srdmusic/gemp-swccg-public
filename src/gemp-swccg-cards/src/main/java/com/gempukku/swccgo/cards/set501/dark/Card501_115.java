 ...
 * Title: AT-M6 Cannon
 */
public class Card501_115 extends AbstractVehicleWeapon {
    public Card501_115() {
        super(Side.DARK, 3, "AT-M6 Cannon", Uniqueness.UNRESTRICTED, ExpansionSet.PLAYTESTING, Rarity.V);

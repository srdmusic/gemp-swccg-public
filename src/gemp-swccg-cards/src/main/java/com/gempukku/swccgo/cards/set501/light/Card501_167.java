...
public class Card501_167 extends AbstractNormalEffect {
    public Card501_167() {
        ...
        setGameText("Deploy on table if Massassi Throne Room on table. Once per game, may [DOWNLOAD] a Yavin 4 battleground. Your non-Jedi Rebels are defense value +1. Once per game, may retrieve a non-[M] non-[PW] Rebel of ability < 5. [Immune to Alter.]");

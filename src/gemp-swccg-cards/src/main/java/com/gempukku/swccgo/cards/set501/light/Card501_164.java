 ...
 */
public class Card501_164 extends AbstractJediMaster {
    public Card501_164() {
        super(Side.LIGHT, 1, 5, 3, 7, 7, "Yoda, Keeper Of The Peace", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

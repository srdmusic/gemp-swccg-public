 ...
 */
public class Card501_211_BACK extends AbstractObjective {
    public Card501_211_BACK() {
        super(Side.LIGHT, 7, Title.We_Need_Luke_Skywalker, ExpansionSet.PLAYTESTING, Rarity.V);

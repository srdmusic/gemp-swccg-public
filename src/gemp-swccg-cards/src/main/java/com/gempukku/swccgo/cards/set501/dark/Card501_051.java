 ...
 */
public class Card501_051 extends AbstractLostOrStartingInterrupt {
    public Card501_051() {
        super(Side.DARK, 3, Title.Rise_Of_The_Sith, Uniqueness.RESTRICTED_2, ExpansionSet.PLAYTESTING, Rarity.V);

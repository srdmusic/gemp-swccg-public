 ...
 * Title: Bodhi Rook
 */
public class Card501_217 extends AbstractRebel {
    public Card501_217() {
        super(Side.LIGHT, 2, 2, 2, 2, 4, Title.Bodhi, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        setLore("Gambler and spy.");
        setGameText("[Pilot] 2, 3: Rogue One or a stolen starship. When deployed, may peek at opponent's hand. If about to be lost, your Rebel or Rebel starship at a related location may make a regular move.");

 ...
 * Title: Cardo
 */
public class Card501_043 extends AbstractFirstOrder {
    public Card501_043() {
        super(Side.DARK, 2, 4, 4, 3, 6, "Cardo", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

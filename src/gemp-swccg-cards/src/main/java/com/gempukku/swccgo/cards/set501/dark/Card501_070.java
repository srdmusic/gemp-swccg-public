...
public class Card501_070 extends AbstractAlienImperial {
    public Card501_070() {
        ...
        setGameText("Deploys +2 to non-battleground locations. May ▼ Mara Jade's Lightsaber here. While Revenge Of The Sith on table, gains [Sith]. If you just won a battle here, may retrieve a card with 'Mara' in game text. Immune to attrition < 4 (< 5 if alone or no Jedi here, < 6 if both).");

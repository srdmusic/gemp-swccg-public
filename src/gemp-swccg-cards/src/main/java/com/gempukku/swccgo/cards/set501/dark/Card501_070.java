...
public class Card501_070 extends AbstractAlienImperial {
    public Card501_070() {
        ...
        setGameText("Functions as your apprentice. Battle destiny draws may not be added here. May [download] Mara Jade's Lightsaber here. If you just won a battle here, may retrieve a card with 'Mara' in gametext. Immune to Rebel Barrier and attrition < 4 (< 5 if Luke on table).");

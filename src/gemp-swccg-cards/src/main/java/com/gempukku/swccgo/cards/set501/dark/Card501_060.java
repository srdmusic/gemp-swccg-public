 ...
 * Title: Ochi
 */
public class Card501_060 extends AbstractSith {
    public Card501_060() {
        super(Side.DARK, 2, 4, 3, 4, 5, "Ochi", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        setLore("Assassin.");

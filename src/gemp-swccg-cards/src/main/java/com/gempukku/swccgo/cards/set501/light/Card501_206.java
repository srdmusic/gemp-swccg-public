 ...
 * Title: A Power Loss
 */
public class Card501_206 extends AbstractEpicEventDeployable {
    public Card501_206() {
        super(Side.LIGHT, PlayCardZoneOption.ATTACHED, Title.A_Power_Loss, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        setLore("");

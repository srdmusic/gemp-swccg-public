...
public class Card501_213 extends AbstractSite {
    public Card501_213() {
        ...
        setLocationLightSideGameText("Deploys only as a starting location. While Wookiee Homestead on table, no Force Drains here.");
        setLocationDarkSideGameText("Until the end of your first turn, you must first use 1 Force to deploy a character to a Kashyyyk site.");

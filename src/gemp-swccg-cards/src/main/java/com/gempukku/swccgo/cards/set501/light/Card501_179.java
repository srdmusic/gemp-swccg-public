 ...
 */
public class Card501_179 extends AbstractCharacterWeapon {
    public Card501_179() {
        super(Side.LIGHT, 5, "Ahsoka's Shoto Lightsaber", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        setLore("");

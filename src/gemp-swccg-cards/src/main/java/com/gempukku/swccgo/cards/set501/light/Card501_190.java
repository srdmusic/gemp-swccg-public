...
public class Card501_190 extends AbstractLostInterrupt {
    public Card501_190() {
        ...
        setGameText("At the start of your turn, if a [CC] Rebel controls a battleground, turn a card stacked on Patience! face up. OR If a [CC] Rebel in battle, add one battle destiny OR Place a [CC] Rebel (except Luke) out of play from hand to cancel all battle damage against you.");

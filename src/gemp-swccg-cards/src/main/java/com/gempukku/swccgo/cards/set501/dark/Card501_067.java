...
public class Card501_067 extends AbstractNormalEffect {
    public Card501_067() {
        ...
        setGameText("If your [Cloud City] objective on table, deploy on table. Imperial Barrier, Stunning Leader, and Surreptitious Glance are canceled. Once per turn, may [download] an interior Cloud City site. Your unique (•) characters with printed forfeit < 5 are forfeit +2 (limit +2). [Immune to Alter.]");

...
public class Card501_066_BACK extends AbstractObjective {
    public Card501_066_BACK() {
        ...
        setGameText("While this side up, It’s a Trap! is canceled. If you have an alien/Imperial pair in battle, your total battle destiny is +2 (or +4 if alien is an Ugnaught). Your Force drain bonuses at same site as your Lando or your Lobot may not be canceled. While Vader present at a Cloud City site, Sense and Alter are canceled. While Executor at Bespin, Cloud City Occupation may not be canceled. Flip this card if opponent controls Bespin system or 3 Cloud City battlegrounds.");

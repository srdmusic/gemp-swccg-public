 ...
 */
public class MayNotHaveTotalAbilityResetModifier extends AbstractModifier {
     ...
     */
    public MayNotHaveTotalAbilityResetModifier(PhysicalCard source, Filterable locationFilter, String playerId) {
     ...
     * @param playerId the player
     */
    public MayNotHaveTotalAbilityResetModifier(PhysicalCard source, Filterable locationFilter, Condition condition, String playerId) {

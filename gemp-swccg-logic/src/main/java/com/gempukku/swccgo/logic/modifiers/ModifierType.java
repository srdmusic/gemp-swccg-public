...
public enum ModifierType {
    ...
    // Card stats
    DESTINY, PRINTED_DESTINY,
    POWER, POWER_LIMIT, PRINTED_POWER, UNMODIFIABLE_POWER, MAY_NOT_HAVE_POWER_REDUCED, MAY_NOT_HAVE_POWER_INCREASED_BY_CARD,
    ...
    DEFENSE_VALUE, UNMODIFIABLE_DEFENSE_VALUE, PRINTED_DEFENSE_VALUE, MIN_DEFENSE_VALUE_REDUCED_TO, MAY_NOT_HAVE_DEFENSE_VALUE_REDUCED, MAY_NOT_HAVE_DEFENSE_VALUE_INCREASED_ABOVE_PRINTED,
    ...
    FORFEIT_VALUE, PRINTED_FORFEIT_VALUE, UNMODIFIABLE_FORFEIT_VALUE, MAY_NOT_HAVE_FORFEIT_VALUE_REDUCED, REMAINS_IN_PLAY_WHEN_FORFEITED, FORFEIT_VALUE_TO_USE, MAY_NOT_HAVE_FORFEIT_VALUE_INCREASED, MAY_NOT_HAVE_FORFEIT_VALUE_INCREASED_ABOVE_PRINTED,
    ...
    GIVE_KEYWORD,
    GIVE_ICON, CANCEL_ICONS, EQUALIZE_FORCE_ICONS, CANCEL_FORCE_ICON, CANCEL_FORCE_ICONS,
    GIVE_SPECIES,
    CANT_STEAL,
    CANT_DRIVE_OR_PILOT,
    ...
    MAY_DEPLOY_WITHOUT_PRESENCE_OR_FORCE_ICONS,
    ...
    INITIATE_BATTLE_FOR_FREE, UNMODIFIABLE_INITIATE_BATTLE_COST, INITIATE_BATTLE_COST, INITIATE_BATTLE_COST_AS_LOSE_FORCE,
    ...
    DRAW_DESTINY_FROM_BOTTOM_OF_DECK, MAY_NOT_CANCEL_DESTINY_DRAWS,
    ...
    // Lightsaber combat
    LIGHTSABER_COMBAT_TOTAL, EACH_LIGHTSABER_COMBAT_DESTINY,
    ...
    EPIC_EVENT_CALCULATION_TOTAL, UNDER_HOTH_ENERGY_SHIELD,

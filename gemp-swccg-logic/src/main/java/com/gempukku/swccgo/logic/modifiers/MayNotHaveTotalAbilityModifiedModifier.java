 ...
 */
public class MayNotHaveTotalAbilityModifiedModifier extends AbstractModifier {
     ...
     */
    public MayNotHaveTotalAbilityModifiedModifier(PhysicalCard source, Filterable locationFilter, String playerId) {
     ...
     * @param playerId the player
     */
    public MayNotHaveTotalAbilityModifiedModifier(PhysicalCard source, Filterable locationFilter, Condition condition, String playerId) {

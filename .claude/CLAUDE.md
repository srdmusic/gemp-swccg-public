...
2. **`Handoffs/K2_MASTER_HANDOFF_2026-07-02.md`** — THE current master handoff (router, consolidated from all four K-2 sessions 2026-07-01): verified state, the two work queues, doc map, pending verifications, Codex status, landmines. This is what to actually do. (Everything superseded lives in `Handoffs/archive/`, history only.)
3. **`/Users/steve/gemp-swccg-public/resources/k2-resources/distilled/00-START-HERE.md`** — the onboarding hub: project overview, build/deploy, Rando architecture, the V21–V186 history, working norms.

PATHS NOTE (2026-06-23, amended 2026-07-01): a LIVE `BUILD_AND_DEPLOY.md` now exists at `resources/BUILD_AND_DEPLOY.md` — use THAT one, not the archived copy. The other foundational deep docs this file names below (the original `K2_MASTER_HANDOFF.md` with the dojo design + Steve's 10 principles + the council §13, `K2_HANDOFF_2026-05-22.md`, `context.md`, `AI_VERSION_HISTORY.md`, `Rando_AI_Rule_Audit.xlsx`) are NOT in this install. They live verbatim in `/Users/steve/gemp-swccg-public/resources/k2-resources/originals/` (`02-rando-history`, `03-handoffs`, `04-setup-context`) and in `GEMP ARCHIVE/gemp-swccg-public-BACKUP-2026-06-20/`. Read them there. (A future K-2 task: decide whether to copy them in or keep pointing out.)

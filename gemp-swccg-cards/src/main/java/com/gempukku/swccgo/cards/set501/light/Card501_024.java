...
public class Card501_024 extends AbstractRebel {
    public Card501_024() {
        ...
        setGameText("Adds 3 to anything he pilots. Stormtrooper. Deploys only if Cell 2187 on table. While armed with a blaster (or with a stormtrooper), adds one battle destiny. Han's weapon destiny draws are +1 for each trooper here. Trooper Assault canceled here.");

...
public class Card501_072 extends AbstractStarfighter {
    public Card501_072() {
        super(Side.LIGHT, 2, 5, 4, null, 4, 4, 6, "Obi-Wan In Jedi Starfighter", Uniqueness.UNIQUE);
        ...
        setGameText("Permanent pilot is •Obi-Wan, who provides ability of 6. Opponent's starships may not 'cloak.' Your total ability here may not be reduced. Immune to Overwhelmed and attrition < 4.");
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        modifiers.add(new ImmuneToTitleModifier(self, Title.Overwhelmed));

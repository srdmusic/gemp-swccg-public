...
public class Card501_041 extends AbstractUsedOrLostInterrupt {
    public Card501_041() {
        ...
        setGameText("USED: During battle, add 1 to your total battle destiny for each card stacked on Thrawn's Art Collection. LOST: Once per game, if you just revealed an Interrupt as 'artwork,' you may take one Interrupt into hand from Lost Pile.");

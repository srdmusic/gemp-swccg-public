...
public class Card501_108 extends AbstractSite {
    public Card501_108() {
        super(Side.LIGHT, "Lothal: Jedi Temple", Title.Lothal);
        setLocationDarkSideGameText("Unless opponent occupies this site, your characters are deploy +4 here.");
    ...
    protected List<Modifier> getGameTextDarkSideWhileActiveModifiers(String playerOnDarkSideOfLocation, SwccgGame game, PhysicalCard self) {
        ...
        modifiers.add(new DeployCostToLocationModifier(self, Filters.and(Filters.your(playerOnDarkSideOfLocation), Filters.character), new UnlessCondition(new OccupiesCondition(game.getOpponent(playerOnDarkSideOfLocation), self)), 4, self));
        return modifiers;
    }

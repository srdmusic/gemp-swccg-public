...
public class Card501_097 extends AbstractLostOrStartingInterrupt {
    public Card501_097() {
        ...
        setGameText("LOST: Target a T-47 defending a battle and choose: Add 2 to maneuver OR Add 2 to immunity to attrition. STARTING: Deploy Echo Base Garrison and and up to 2 Effects that deploys for free and are always immune to Alter. Place Interrupt in Lost Pile.");
    ...
    protected List<PlayInterruptAction> getGameTextTopLevelActions(final String playerId, SwccgGame game, final PhysicalCard self) {
        ...
        // Check condition(s)
        if (GameConditions.canTarget(game, self, t47defending)) {

 ...
 */
public class Card501_127 extends AbstractCharacterWeapon {
    public Card501_127() {
        super(Side.LIGHT, 1, "Qui-Gon Jinn's Lightsaber", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setTestingText("Qui-Gon Jinn's Lightsaber (V)");
    }

...
public class Card501_010_BACK extends AbstractObjective {
    public Card501_010_BACK() {
        ...
        setGameText("While this side up, game text of your Admiral's Orders may not be suspended. Opponent may not reduce your Force drains. Rebel Leadership and We're Doomed are Lost Interrupts. Attrition against opponent is +1 for each Imperial leader in battle. Your Force drains are +1 at opponent's sites (or Echo sites) where your snowtrooper or non-unique AT-AT present. Adds one [Dark Side] icon and one [Light Side] icon at 'blown away' sites.  \n" +
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, PhysicalCard self) {
        ...
        modifiers.add(new MayNotHaveGameTextCanceledModifier(self, Filters.and(Filters.your(self), Filters.Admirals_Order)));
        modifiers.add(new ForceDrainsMayNotBeReducedModifier(self, Filters.location, opponent, playerId));
        ...
        modifiers.add(new IconModifier(self, Filters.and(Filters.site, Filters.blown_away), Icon.DARK_FORCE));
        modifiers.add(new IconModifier(self, Filters.and(Filters.site, Filters.blown_away), Icon.LIGHT_FORCE));
        return modifiers;
    }

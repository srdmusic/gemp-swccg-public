...
public class Card501_154 extends AbstractCapitalStarship {
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        modifiers.add(new TotalBattleDestinyModifier(self, new AloneCondition(self), new OnTableEvaluator(self, Filters.and(Filters.your(self), Filters.gangster, Filters.aboard(self))), self.getOwner()));

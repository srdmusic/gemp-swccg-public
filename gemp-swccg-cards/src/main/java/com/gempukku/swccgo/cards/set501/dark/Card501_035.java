 ...
 */
public class Card501_035 extends AbstractUsedOrLostInterrupt {
    public Card501_035() {
        super(Side.DARK, 4, "Force Push & Podracer Collision", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

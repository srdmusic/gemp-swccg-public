...
public class Card501_143 extends AbstractNormalEffect {
    public Card501_143() {
        super(Side.LIGHT, 3, PlayCardZoneOption.ATTACHED, Title.Reflection, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setGameText("Deploy on Rebel leader Leia. " +
                "She is defense value and immunity to attrition +1. " +
                "While at a battleground, Force drain +1 here and, " +
                "whenever you initiate a battle with a Rebel of ability < 5, " +
                "retrieve 1 Force (2 if Leia initiating against an Imperial). " +
                "Lost if a Jedi communing. [Immune to Alter.]");

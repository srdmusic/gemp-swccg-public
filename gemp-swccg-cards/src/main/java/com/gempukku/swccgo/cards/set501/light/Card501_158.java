 ...
 */
public class Card501_158 extends AbstractUsedInterrupt {
    public Card501_158() {
        super(Side.LIGHT, 4, "Generation One Armor Always Holds Up", Uniqueness.UNRESTRICTED, ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setTestingText("Generation One Armor Always Holds Up");
    }

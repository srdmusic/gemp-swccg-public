...
public class Card501_020_BACK extends AbstractSystem {
    ...
    protected List<RequiredGameTextTriggerAction> getGameTextDarkSideRequiredAfterTriggers(String playerOnDarkSideOfLocation, SwccgGame game, EffectResult effectResult, PhysicalCard self, int gameTextSourceCardId) {
        if (GameConditions.canBeFlipped(game, self)
                && (TriggerConditions.forceDrainCompleted(game, effectResult,  playerOnDarkSideOfLocation, Filters.Geonosis_site)
    ...
    protected List<Modifier> getGameTextLightSideWhileActiveModifiers(String playerOnLightSideOfLocation, SwccgGame game, PhysicalCard self) {
        ...
        modifiers.add(new DestinyModifier(self, Filters.and(Filters.your(playerOnLightSideOfLocation), Filters.clone), new OccupiesWithCondition(playerOnLightSideOfLocation, self, Filters.and(Icon.REPUBLIC, Filters.starship)), 1));
        modifiers.add(new PowerModifier(self, Filters.and(Filters.your(playerOnLightSideOfLocation), Filters.clone), new OccupiesWithCondition(playerOnLightSideOfLocation, self, Filters.and(Icon.REPUBLIC, Filters.starship)), 1));
        return modifiers;
    }
}
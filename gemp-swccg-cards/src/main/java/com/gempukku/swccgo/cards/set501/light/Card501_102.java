 ...
 */
public class Card501_102 extends AbstractObjective {
    public Card501_102() {
        super(Side.LIGHT, 0, Title.Local_Uprising);
    ...
    protected List<TopLevelGameTextAction> getGameTextTopLevelActions(final String playerId, SwccgGame game, final PhysicalCard self, int gameTextSourceCardId) {
        ...
        GameTextActionId gameTextActionId = GameTextActionId.LOCAL_UPRISING_V__DOWNLOAD_SITE;
        ...
        if (GameConditions.isOnceDuringYourPhase(game, self, playerId, gameTextSourceCardId, gameTextActionId, Phase.DEPLOY)
            ...
            // Perform result(s)
            action.appendEffect(
                    new DeployCardToSystemFromReserveDeckEffect(action, Filters.site, subjugatedPlanet, true));
    ...
    protected List<RequiredGameTextTriggerAction> getGameTextRequiredAfterTriggers(SwccgGame game, EffectResult effectResult, PhysicalCard self, int gameTextSourceCardId) {
        ...
        if (TriggerConditions.isTableChanged(game, effectResult)
                ...
                && (GameConditions.occupies(game, playerId, Filters.Subjugated_system))) {

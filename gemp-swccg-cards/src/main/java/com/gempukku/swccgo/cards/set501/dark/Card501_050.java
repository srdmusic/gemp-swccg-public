 ...
 */
public class Card501_050 extends AbstractCapitalStarship {
    public Card501_050() {
        ...
        setGameText("May add 6 pilots, 8 passengers, 2 vehicles and 4 TIEs. Permanent pilot provides ability of 2. While Khurgee aboard, power, armor, and hyperspeed +2. Moves for free if Death Star II on table.");

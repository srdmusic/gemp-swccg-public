...
public class Card501_039 extends AbstractSith {
    public Card501_039() {
        ...
        setGameText("Deploys -1 if Dooku on table. Whenever a player loses a battle here, that player loses 1 Force. While armed with a lightsaber, opponent's weapon destiny draws are -1 here. Opponent may not cancel battles here. Immune to [Permanent] weapons and attrition < 4.");
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        List<Modifier> modifiers = new LinkedList<>();
        modifiers.add(new EachWeaponDestinyModifier(self, Filters.and(Filters.opponents(self), Filters.weapon, Filters.here(self)), new ArmedWithCondition(self, Filters.lightsaber), -1));

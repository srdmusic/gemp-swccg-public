 ...
 */
public class Card501_147 extends AbstractNormalEffect {
    public Card501_147() {
        super(Side.DARK, 4, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "Holowan Laboratories", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        setLore("");
        setGameText("Deploy on table. If your IG-88 or MagnaGuard was just lost, may place it here. " +
                ...
                "While two MagnaGuards on Invisible Hand, Menace Fades is suspended. [Immune to Alter.]");
        addIcons(Icon.EPISODE_I, Icon.VIRTUAL_SET_22);
        addImmuneToCardTitle(Title.Alter);
        setTestingText("Holowan Laboratories");
    }

 ...
 */
public class Card501_131 extends AbstractLostInterrupt {
    public Card501_131() {
        ...
        setGameText("If opponent just lost a battle, they lose 2 Force. " +
                "OR During battle, if Obi-Wan is participating (or 'communing'), add one battle destiny; " +
                "characters may not be 'revived' this turn. OR Cancel Clash Of Sabers targeting your Dark Jedi.");

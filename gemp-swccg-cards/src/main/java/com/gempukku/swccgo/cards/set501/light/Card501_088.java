 ...
 */
public class Card501_088 extends AbstractObjective {
    public Card501_088() {
    ...
    protected RequiredGameTextTriggerAction getGameTextAfterDeploymentCompletedAction(String playerId, SwccgGame game, final PhysicalCard self, final int gameTextSourceCardId) {
        ...
        action.appendEffect(
                new AddUntilEndOfGameModifierEffect(action,
                        new MayNotDeployModifier(self, Filters.or(Filters.Luke, Filters.Jedi, Filters.Harc, Filters.and(Icon.EPISODE_I, Filters.character)), playerId), null));
        action.appendEffect(
                new AddUntilEndOfGameModifierEffect(action,

...
public class Card501_088 extends AbstractRebelResistance {
    public Card501_088() {
        ...
        setGameText("Adds 3 to power of anything he pilots. Kylo's game text is canceled here. During battle with Chewie or an [Endor] scout (or while piloting Tydirium), adds one battle destiny. When deployed, may reveal top two cards of Reserve Deck; take one into hand; place other on Used Pile.");
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        modifiers.add(new AddsBattleDestinyModifier(self, new OrCondition(new InBattleWithCondition(self, Filters.or(Filters.Chewie, Filters.and(Icon.ENDOR, Filters.scout))), new PilotingCondition(self, Filters.Tydirium)), 1));
        return modifiers;
    }

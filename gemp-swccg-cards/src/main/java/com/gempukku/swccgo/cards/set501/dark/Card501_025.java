...
public class Card501_025 extends AbstractCapitalStarship {
    public Card501_025() {
        ...
        addIcons(Icon.HOTH, Icon.PILOT, Icon.NAV_COMPUTER, Icon.SCOMP_LINK, Icon.VIRTUAL_SET_19);
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        modifiers.add(new ImmuneToAttritionLessThanModifier(self, new AtCondition(self, Filters.Hoth_system), 4));
        return modifiers;
    }

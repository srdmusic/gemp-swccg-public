 ...
 * Title: Cal Kestis
 */
public class Card501_052 extends AbstractRebelRepublic {
    public Card501_052() {
        super(Side.LIGHT, 2, 4, 4, 4, 5, "Cal Kestis", Uniqueness.UNIQUE);
        setLore("Padawan");
        setGameText("Once per game, if you are about to draw a card for battle destiny here, may instead use Cal Kestis's ability number. " +
                "During opponent's draw phase, may place one card from your hand under Reserve Deck; reshuffle and draw top card of Reserve Deck.");
        addIcons(Icon.WARRIOR, Icon.VIRTUAL_SET_15);
        addKeywords(Keyword.PADAWAN);
        setTestingText("Cal Kestis");
    }

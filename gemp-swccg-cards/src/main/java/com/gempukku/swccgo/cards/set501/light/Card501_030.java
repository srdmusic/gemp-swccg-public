...
public class Card501_030 extends AbstractNormalEffect {
    public Card501_030() {
        ...
        setLore("");
        setGameText("Deploy on Slave Quarters. Anakin is deploy = 6. Once per turn, may [download] Anakin's Lightsaber (or lose 1 Force to deploy it from Lost Pile). If Anakin drawn for destiny, may take him into hand to cancel and cause a re-draw. [Immune to Alter.]");

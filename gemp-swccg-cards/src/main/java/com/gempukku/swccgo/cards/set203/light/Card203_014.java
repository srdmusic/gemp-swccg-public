...
public class Card203_014 extends AbstractNormalEffect {
    public Card203_014() {
        ...
        setGameText("Deploy on R2-D2. If about to leave table (even if inactive or from Overwhelmed), relocate to Dune Sea. If at Dune Sea, may relocate to your character there. If at Alderaan (or a 'blown way' system), tapes 'delivered'; relocate this Effect to table and may [upload] any card. [Immune to Alter]");

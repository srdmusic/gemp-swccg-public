 ...
 * Title: Mandalore
 */
public class Card501_113 extends AbstractSystem {
    public Card501_113() {
        super(Side.LIGHT, Title.Mandalore, 4);
        setLocationDarkSideGameText("If Darksaber deployed on your character, opponent may not deploy or Force drain here.");
        setLocationLightSideGameText("If your Mandalorian here, Force drain +1 here (+2 if Darksaber here).");

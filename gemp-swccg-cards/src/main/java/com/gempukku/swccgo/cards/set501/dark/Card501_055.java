 ...
 * Title: Chimaera (V)
 */
public class Card501_055 extends AbstractCapitalStarship {
    public Card501_055() {
        ...
        setGameText("May add 6 pilots, 6 passengers, and 4 TIEs. Permanent pilot provides ability of 2. While Thrawn piloting, immune to attrition < 5 and game text of We’re In Attack Position Now may not be canceled.");

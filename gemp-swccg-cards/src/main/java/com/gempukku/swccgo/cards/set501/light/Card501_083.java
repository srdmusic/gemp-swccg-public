...
public class Card501_083 extends AbstractDefensiveShield {
    public Card501_083() {
        ...
        setGameText("Plays on table. May use 2 Force to target opponent's hand of > 14 cards; shuffle all but 9 random cards into opponent's Used Pile. If Monnok or Drop! just targeted your hand, may reveal two cards from hand to 'protect' them.");

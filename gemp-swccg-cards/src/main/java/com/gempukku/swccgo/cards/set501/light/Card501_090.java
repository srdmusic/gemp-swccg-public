 ...
 * Title: Ultimatum (V)
 */
public class Card501_090 extends AbstractDefensiveShield {
    public Card501_090() {
        super(Side.LIGHT, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, Title.Ultimatum, ExpansionSet.PLAYTESTING, Rarity.V);

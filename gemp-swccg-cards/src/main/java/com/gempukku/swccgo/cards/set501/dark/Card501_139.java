...
public class Card501_139 extends AbstractAlien {
    public Card501_139() {
        ...
        setGameText("While at Cantina neither player may fire more than one weapon during battle here and if Jabba on table, " +
                "opponent generates no Force here. Once per game may retrieve (or take into hand from Reserve Deck; reshuffle) Restraining Bolt.");

...
public class Card501_157 extends AbstractNormalEffect {
    public Card501_157() {
        super(Side.DARK, 6, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "Deactivated Hyperdrive", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setTestingText("Deactivated Hyperdrive");
    }

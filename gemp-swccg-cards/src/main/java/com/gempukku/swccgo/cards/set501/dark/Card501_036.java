...
public class Card501_036 extends AbstractStarfighter {
    public Card501_036() {
        super(Side.DARK, 2, 4, 4, 5, null, 4, 7, "Night Buzzard", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        setGameText("May add 1 pilot and 3 passengers. Permanent pilot is •Kuruk, who provides ability of 3. Kylo and Knights of Ren deploy -1 to same and related locations. Immune to attrition < 4.");

 ...
 * Title: Han's Medal
 */
public class Card501_082 extends AbstractCharacterDevice {
    public Card501_082() {
        super(Side.LIGHT, 5, "Han's Medal", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);

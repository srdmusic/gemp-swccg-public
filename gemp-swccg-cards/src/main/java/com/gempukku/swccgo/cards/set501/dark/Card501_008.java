...
public class Card501_008 extends AbstractEpicEventDeployable {
    public Card501_008() {
        super(Side.DARK, PlayCardZoneOption.ATTACHED, Title.Target_The_Main_Generator, Uniqueness.UNRESTRICTED, ExpansionSet.PLAYTESTING, Rarity.V);
        setGameText("Deploy on Ice Plains. Once per turn, if a player controls this site, they may have this card follow their vehicle moving from here to an adjacent marker site. At the start of your deploy phase, if at 3rd Marker or lower, your AT-AT cannon here may fire (if within range of Main Power Generators) as follows: Draw destiny. Add 1 for each marker site you occupy (2 if you control). If total destiny > 8, 'blow away' Main Power Generators.");

 ...
 */
public class Card501_001 extends AbstractLostInterrupt {
    public Card501_001() {
        super(Side.DARK, 3, "Shattered Hope", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setTestingText("Shattered Hope (V)");
    }

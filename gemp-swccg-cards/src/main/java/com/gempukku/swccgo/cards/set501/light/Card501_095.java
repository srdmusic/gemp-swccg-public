...
public class Card501_095 extends AbstractEpicEventDeployable {
    public Card501_095() {
        ...
        setGameText("Deploy on Bunker if your [V22] objective on table. " +
    ...
    protected boolean checkGameTextDeployRequirements(String playerId, SwccgGame game, PhysicalCard self, PlayCardOptionId playCardOptionId, boolean asReact) {
        return Filters.canSpot(game, self, Filters.and(Filters.your(playerId), Filters.icon(Icon.VIRTUAL_SET_22), Filters.Objective));
    }

...
public class Card501_026 extends AbstractSystem {
    ...
    protected List<RequiredGameTextTriggerAction> getGameTextDarkSideRequiredAfterTriggers(String playerOnDarkSideOfLocation, SwccgGame game, EffectResult effectResult, PhysicalCard self, int gameTextSourceCardId) {
        if (GameConditions.canBeFlipped(game, self)
                && (TriggerConditions.forceDrainCompleted(game, effectResult,  playerOnDarkSideOfLocation, Filters.Christophsis_site)
                || TriggerConditions.wonBattleAt(game, effectResult, playerOnDarkSideOfLocation, Filters.Christophsis_site))) {
    ...
    protected List<Modifier> getGameTextLightSideWhileActiveModifiers(String playerOnLightSideOfLocation, SwccgGame game, PhysicalCard self) {
        ...
        modifiers.add(new DeployCostToLocationModifier(self, Filters.and(Filters.your(playerOnLightSideOfLocation), Filters.character), new ControlsCondition(playerOnLightSideOfLocation, self), -1, Filters.Christophsis_site));
        return modifiers;
    }
}
...
public class Card501_109 extends AbstractSite {
    public Card501_109() {
        ...
        setLocationDarkSideGameText("If a player controls, their total power is +2 at related locations.");
        setLocationLightSideGameText("May deploy Thrawn here from Reserve Deck; reshuffle.");

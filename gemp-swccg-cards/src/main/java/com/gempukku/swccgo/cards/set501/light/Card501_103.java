 ...
 */
public class Card501_103 extends AbstractResistance {
    public Card501_103() {
        super(Side.LIGHT, 1, 4, 3, 3, 6, "General Poe Dameron", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        setLore("Leader.");
        ...
        setTestingText("General Poe Dameron");
    }

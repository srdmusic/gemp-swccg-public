 ...
 * Title: Danz Borin (V)
 */
public class Card501_163 extends AbstractAlien {
    public Card501_163() {
        super(Side.DARK, 3, 3, 2, 2, 4, Title.Danz_Borin, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setGameText("Adds 3 to power of anything he pilots. While a passenger at Nar Shaddaa (or Nal Hutta), " +
                "your Force drains, battle (and weapon) destiny draws are +1 here. During your turn, opponent may use 3" +
                "Force to cancel Borin's game text until end of turn.");
        addIcons(Icon.A_NEW_HOPE, Icon.PILOT, Icon.VIRTUAL_SET_22);
        addKeywords(Keyword.GUNNER, Keyword.BOUNTY_HUNTER);
        setTestingText("Danz Borin (V)");
    }

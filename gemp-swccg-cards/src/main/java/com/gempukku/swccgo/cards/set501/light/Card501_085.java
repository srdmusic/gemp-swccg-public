 ...
 */
public class Card501_085 extends AbstractSite {
    public Card501_085() {
        super(Side.LIGHT, "Ajan Kloss: Training Course", Title.Ajan_Kloss);
        setLocationDarkSideGameText("");
        setLocationLightSideGameText("Deploys only at start of game. If you just chose You Have That Power, Too on your [Skywalker] objective, deploy My Parents Were Strong from Reserve Deck; reshuffle.");
    ...
    protected List<RequiredGameTextTriggerAction> getGameTextLightSideRequiredAfterTriggers(String playerOnLightSideOfLocation, SwccgGame game, EffectResult effectResult, PhysicalCard self, int gameTextSourceCardId) {
        ...
        if (TriggerConditions.justMadeChoice(game, effectResult, playerOnLightSideOfLocation, Filters.and(Icon.SKYWALKER, Filters.Objective))

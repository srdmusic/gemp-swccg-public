...
public class Card501_100 extends AbstractAlien {
    public Card501_100() {
        ...
        setGameText("Adds 3 to power of anything he pilots. Permanent weapon is •Boba Fett's Blaster Rifle (may target a character or creature for free; draw destiny; if destiny > ability; target captured; otherwise, if destiny +2 > ability, target hit, it's forfeit -3 and opponent loses 1 Force).");

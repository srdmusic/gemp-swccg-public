...
public class Card501_152 extends AbstractSite {
    ...
    protected List<Modifier> getGameTextLightSideWhileActiveModifiers(String playerOnLightSideOfLocation, SwccgGame game, PhysicalCard self) {
        List<Modifier> modifiers = new LinkedList<>();
        modifiers.add(new ExtraForceCostToFireWeaponModifier(self, Filters.and(Filters.your(playerOnLightSideOfLocation), Filters.here(self), Filters.lightsaber),
                new UnlessCondition(new HereCondition(self, Filters.ObiWan)), 1));
        return modifiers;
    }
}
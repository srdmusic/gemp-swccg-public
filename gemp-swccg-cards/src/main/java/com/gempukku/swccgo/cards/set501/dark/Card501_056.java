 ...
 */
public class Card501_056 extends AbstractCharacterWeapon {
    public Card501_056() {
        ...
        setGameText("Deploy on [EP1] Vader. Adds 1 to Force drains here. May target a character or creature for free. Draw two destiny. Add 1 if targeting a padawan; subtract 1 if targeting Obi-wan. Target 'hit' and forfeit = 0 if total destiny > defense value");
        addPersona(Persona.VADERS_LIGHTSABER);
        addKeywords(Keyword.LIGHTSABER);
        addIcon(Icon.EPISODE_I);
        setMatchingCharacterFilter(Filters.Vader);
        setTestingText("Vader's Lightsaber (V)");
    }

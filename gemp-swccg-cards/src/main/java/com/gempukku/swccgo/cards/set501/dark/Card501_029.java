...
public class Card501_029 extends AbstractEpicEventDeployable {
    public Card501_029() {
        ...
        setGameText("Deploy on Executor if you have not deployed an objective." +
                "We're Not Going To Attack?: Your squadrons are destiny = 0. You may not deploy Squadrons or non-Imperial Starships. Dreaded Imperial Starfleet is suspended if you do not occupy a battleground site." +
                "The Alliance Will Die...: Flagship Operations may deploy regardless of deployment restrictions." +
                "...As Will Your Friends: At battleground systems where you have a capital starship and a piloted TIE, your Force drains = 2. At sites related to systems you control, during battle may add one destiny to total power. If about to be lost, you lose 3 Force.");

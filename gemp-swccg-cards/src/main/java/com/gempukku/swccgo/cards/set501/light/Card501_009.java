...
public class Card501_009 extends AbstractNormalEffect {
    public Card501_009() {
        ...
        setGameText("Deploy on table. While armed, Din draws one battle destiny if unable to otherwise, and is immune to Disarmed and attrition <4. Once per turn, may [Download] one character weapon or device on your Mandalorian. If Din about to be lost, your cards on him go to Used Pile. [Immune to Alter.]");

...
public class Card501_011 extends AbstractStartingInterrupt {
    public Card501_011() {
        ...
        setGameText("If 5th marker on table, take [Set 6] Veers into hand from Reserve Deck. Deploy 1st marker, [Set 9] Prepare For A Surface Attack, and up to two Effects that deploy for free and are always immune to Alter. Place Interrupt in Lost Pile.");
    ...
    protected PlayInterruptAction getGameTextStartingAction(final String playerId, final SwccgGame game, final PhysicalCard self) {
        ...
        if (Filters.canSpot(game, self, Filters.Fifth_Marker)) {

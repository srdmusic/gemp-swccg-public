...
public class Card501_089 extends AbstractSite {
    public Card501_089() {
        super(Side.LIGHT, "Scarif: Data Vault Control Room", Title.Scarif, Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        addIcons(Icon.INTERIOR_SITE, Icon.PLANET, Icon.SCOMP_LINK, Icon.VIRTUAL_SET_21);

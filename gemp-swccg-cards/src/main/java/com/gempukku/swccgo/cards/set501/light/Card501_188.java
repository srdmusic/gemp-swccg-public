 ...
 */
public class Card501_188 extends AbstractDefensiveShield {
    public Card501_188() {
        super(Side.LIGHT, PlayCardZoneOption.YOUR_SIDE_OF_TABLE, "The Republic No Longer Functions", ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setTestingText("The Republic No Longer Functions (ERRATA)");
    }

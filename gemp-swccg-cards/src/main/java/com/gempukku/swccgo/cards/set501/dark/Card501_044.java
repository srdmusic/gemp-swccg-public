 ...
 */
public class Card501_044 extends AbstractImperial {
    public Card501_044() {
        super(Side.DARK, 3, 2, 2, 2, 3, "Corporal Drazin", Uniqueness.UNIQUE, ExpansionSet.PLAYTESTING, Rarity.V);
        ...
        setTestingText("Corporal Drazin (V)");
    }

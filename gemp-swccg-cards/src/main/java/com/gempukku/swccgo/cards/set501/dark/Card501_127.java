 ...
 * Title: Alpha 1
 */
public class Card501_127 extends AbstractStarfighter {
    public Card501_127() {
        ...
        setPilotCapacity(1);
        setMatchingPilotFilter(Filters.title("Maarek Stele, The Emperor's Reach"));
        setTestingText("Alpha 1");
    }
    ...
    protected List<Modifier> getGameTextWhileActiveInPlayModifiers(SwccgGame game, final PhysicalCard self) {
        ...
        Condition stelePiloting = new HasPilotingCondition(self, Filters.title("Maarek Stele, The Emperor's Reach"));

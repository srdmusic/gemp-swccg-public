 ...
 */
public class Card601_177 extends AbstractDroid {
    public Card601_177() {
        super(Side.DARK, 3, 3, 2, 3, "4-LOM With Concussion Rifle", Uniqueness.UNIQUE);
        ...
        addIcons(Icon.PREMIUM, Icon.WARRIOR, Icon.PERMANENT_WEAPON, Icon.LEGACY_BLOCK_6);

...
public enum GameTextActionId {
    ...
    RESCUE_THE_PRINCESS__DOWNLOAD_SITE_OR_A_POWER_LOSS(true),
    ...
    C_3PO_V_DRAW_TOP_CARD_OF_USED_PILE(false, true),
    ...
    DEATH_STAR_CENTRAL_CORE__DOWNLOAD_TROOPER(true, true),

...
public enum GameTextActionId {
    ...
    A_SITH_LEGEND__DOWNLOAD_LIGHTSABER(true),
    ...
    TRAGEDY_OF_PLAGEUS__DOWNLOAD_LIGHTSABER_ON_SIDIOUS(true),
    ...
    OFF_WORLD_JAWAS__SEARCH_RESERVE_DECK(true),
    ...
    TATOOINE_LARS_HOMESTEAD__DEPLOY_ANAKINS_LIGHTSABER(true, true, false, false, false, true),
    ...
    SURELY_YOU_CAN_DO_BETTER__CANCEL_INTERRUPT(false, true),
    ...
    TRAGEDY_OF_PLAGEUS__RETURN_CHARACTER_TO_HAND_FROM_LOST_PILE(true, true),
    NOW_IT_CALLS_TO_YOU__DOWNLOAD_ANAKINS_SABER(true, true),
    ...
    LEGACY__HUNT_DOWN_V__UPLOAD_ROGUES_SHADOW(true),

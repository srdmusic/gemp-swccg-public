...
public enum GameTextActionId {
    ...
    BEST_STARPILOT_IN_THE_GALAXY__REVEAL_SHIP_OR_PILOT(true),
    ...
    NEIMOIDIAN_ADVISOR_V__UPLOAD_CARD(true),
    NEIMOIDIAN_ADVISOR_V__DOWNLOAD_BRIDGE(true),
    ...
    SHADOWS_OF_THE_EMPIRE_INFORMATION_EXCHANGE__UPLOAD_IMPERIAL_SQUARE_OR_EMPEROR(true),
    ...
    SURELY_YOU_CAN_DO_BETTER__UPLOAD_THE_WORKS(true),

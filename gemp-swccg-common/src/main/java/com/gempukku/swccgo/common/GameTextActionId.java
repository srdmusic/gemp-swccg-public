...
public enum GameTextActionId {
    ...
    CHANGING_THE_ODDS_DARTH_MAULS_DEMISE__SEARCH_USED_PILE(true),
    ...
    MY_SISTER_HAS_IT__UPLOAD_CARD(true),
    ...
    THE_SHIELD_WILL_BE_DOWN__DOWNLOAD_ATAT_OR_TROOPER(true),
    ...
    THRAWN_PINCER__EXCHANGE_CARD(true),
    ...
    CHANGING_THE_ODDS_DARTH_MAULS_DEMISE__SEARCH_LOST_PILE(true, true),
    ...
    I_MUST_BE_ALLOWED_TO_SPEAK_SMUGGLERS_BLUES__DOWNLOAD_MOS_EISLEY(true, true),

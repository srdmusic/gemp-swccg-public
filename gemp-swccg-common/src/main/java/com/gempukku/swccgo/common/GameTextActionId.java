...
public enum GameTextActionId {
    ...
    CORPORAL_OBERK_V__DEPLOY_LOCATION_FROM_FORCE_PILE(true),
    ...
    JURI_JUICE_V__DEPLOY_CARD(true),
    JURI_JUICE_V__TAKE_CARD_INTO_HAND_FROM_USED_PILE(true),
    ...
    PROTECT_THE_RIDE__DOWNLOAD_LOCATION(true),
    ...
    THE_GALAXY_TORN_APART__DEPLOY_CHARACTER_FROM_RESERVE_DECK(true),
    ...
    THE_SHIELD_WILL_BE_DOWN__DOWNLOAD_HOTH_SITE(true),
    ...
    YOU_CANNOT_ESCAPE_YOUR_DESTINY__DEPLOY_CARD_FROM_RESERVE_DECK(true),
    ...
    CANTINA__DEPLOY_CARD(true, true),
    ...
    I_CANT_BELIEVE_HES_GONE__RETURN_A_REBEL(true, true),
    ...
    SEND_A_DETACHMENT_DOWN_V__DEPLOY_CARD(true, true),
    ...
    TONNIKA_SISTERS_V__CHOICE(false, true),

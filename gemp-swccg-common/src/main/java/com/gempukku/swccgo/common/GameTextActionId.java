...
public enum GameTextActionId {
    ...
    THE_SITH_RULE_THE_GALAXY__UPLOAD_WEAPON(true),
    ...
    WHAT_GIVES_A_JEDI_HIS_POWER__UPLOAD_WEAPON(true),
    ...
    MY_PARENTS_WERE_STRONG__DOWNLOAD_HIDDEN_RECESS(true, true),
    ...
    RULE_OF_TWO__EXCHANGE_CARDS(true, true),
    ...
    THE_FORCE_IS_STRONG_IN_MY_FAMILY__DOWNLOAD_ANAKINS_SABER(true, true),
